namespace calcurator
{
    ...
    { 
        ...
        private double widthArg = 0.15;
        private double heightArg = 0.15;
        ...
        public ActionButton(string action, int posX, int posY,int sizeX,Form form)
        {
            Action = action;
            PosX = posX;
            PosY = posY;
            this.Location = new Point(Convert.ToInt32((form.Size.Width * widthArg * posX) + (form.Size.Width * offsetBorders)), Convert.ToInt32((form.Size.Height * (heightArg * PosY)) + (form.Size.Height * offsetBottom)));
            this.Size = new Size(Convert.ToInt32(form.Size.Width * widthArg*sizeX), Convert.ToInt32(form.Size.Height * heightArg));
            form.Controls.Add(this);
            this.Show();
            Text = action;
            Click += OnClick;
        }
        public ActionButton(string action, int posX, int posY, int sizeX,int sizeY, Form form)
        {
            Action = action;
            PosX = posX;
            PosY = posY;
            this.Location = new Point(Convert.ToInt32((form.Size.Width * widthArg * posX) + (form.Size.Width * offsetBorders)), Convert.ToInt32((form.Size.Height * (heightArg * PosY)) + (form.Size.Height * offsetBottom)));
            this.Size = new Size(Convert.ToInt32(form.Size.Width * widthArg * sizeX), Convert.ToInt32(form.Size.Height * heightArg*sizeY));
            form.Controls.Add(this);
            this.Show();
            Text = action;
            Click += OnClick;
